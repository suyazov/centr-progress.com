...
<div class="FilterBlock bx-filter">
			...
			<?endforeach;?>
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box bx-active">
							...
							<div class="Name bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)"><?=$arItem["NAME"]?> <span data-role="prop_angle" class="<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></span></div>
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="Label bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="bx-filter-container-modef"></span>
						
							<?if($arItem["ID"]!="16"):?><div class="Name bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
							<?=$arItem["NAME"]?>
								...
								<?endif?>
								<span data-role="prop_angle" class="<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></span>
						</div>
								<?endif?>
									...
									<div class="Label">
										<?foreach($arItem["VALUES"] as $val => $ar):?>
											<div class="checkbox">
												...
												<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx-filter-param-label <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>"><span><?=$ar["VALUE"];?></span></label>
											</div>
										<?endforeach;?>
									</div>
							<?
				...
				?>
				<div class="Button bx-filter-button-box" style="display:none">
